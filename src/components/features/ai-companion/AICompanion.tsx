...
export default function AICompanion() {
  ...
  const toggleListening = () => {
    ...
    if (!support.hasAPI) {
      setError('Speech recognition is not supported in your browser. Please try using your keyboard\'s voice input feature.');
      return;
    }
    
    if (support.useNativeInput) {
      // Show helpful tooltip for mobile users
      setError('For best results, tap the microphone icon on your keyboard');
