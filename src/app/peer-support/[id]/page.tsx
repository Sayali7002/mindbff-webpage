...
export default function PeerDetailPage({ params }: { params: { id: string } }) {
  ...
  const sharedJourneys = userProfile?.supportPreferences && peer?.supportPreferences
            ...
            <div className="mb-6">
              ...
              <div className="bg-gray-100 h-4 rounded-full overflow-hidden">
                <div 
                  ...
                  style={{ width: `${peer.matchScore ?? 0}%` }}
                />
              </div>
              <div className="flex justify-between mt-1">
                <span className="text-xs text-gray-500">0%</span>
                <span className="text-xs font-medium text-blue-600">{peer.matchScore ?? 0}%</span>
